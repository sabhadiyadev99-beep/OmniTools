...
export default function App() {
  return (
    <HelmetProvider>
      <Router>
        <div className="min-h-screen bg-white dark:bg-slate-950 text-slate-950 dark:text-slate-50 flex flex-col transition-colors duration-300">
          <Header />
  ...
  return (
    <div className="max-w-4xl mx-auto px-6 py-20 space-y-8">
      ...
      <p className="text-slate-500 dark:text-slate-400 text-lg leading-relaxed max-w-2xl">
        ToolVanta was built to provide high-quality digital utilities for free. 
